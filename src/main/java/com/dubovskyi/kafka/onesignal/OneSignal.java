 ...
 */
package com.dubovskyi.kafka.onesignal;

import com.dubovskyi.kafka.onesignal.model.SuccessResponse;
import com.dubovskyi.kafka.onesignal.model.app.App;
import com.dubovskyi.kafka.onesignal.model.app.AppResponse;
import com.dubovskyi.kafka.onesignal.model.notification.CreateNotificationResponse;
import com.dubovskyi.kafka.onesignal.model.notification.NotificationRequest;
import com.dubovskyi.kafka.onesignal.model.notification.ViewNotificationResponse;
import com.dubovskyi.kafka.onesignal.model.notification.ViewNotificationsResponse;
import com.dubovskyi.kafka.onesignal.model.player.*;
...
public final class OneSignal {
     ...
     * {@link com.dubovskyi.kafka.onesignal.model.player.Device#sessionCount sessionCount}, and should also be used to
     * update any fields that may have changed (such as
     * {@link com.dubovskyi.kafka.onesignal.model.player.Device#language language} or
     * {@link com.dubovskyi.kafka.onesignal.model.player.Device#timezone timezone}).
     * @param deviceId The device's OneSignal ID
     ...
     * <p>
     * This will increment the player's {@link com.dubovskyi.kafka.onesignal.model.player.Device#amountSpent amountSpent}.
     * @param deviceId The device's OneSignal ID
    ...
    /**
     * Update a device's {@link com.dubovskyi.kafka.onesignal.model.player.Device#playtime playtime} upon app resuming.
     * <p>
    ...
    private static OneSignalComms oneSignal() {
        ...
        return Feign.builder()
                ...
                .logLevel(Level.FULL)
                .target(OneSignalComms.class, "http://172.28.27.220:8089");
    }
